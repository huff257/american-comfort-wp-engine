...
function enqueue_ga4_head() {
	?>
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-7LSTQDXWY9"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-7LSTQDXWY9');
        </script>
	<?php
}
add_action( 'wp_head', 'enqueue_ga4_head', 1 );